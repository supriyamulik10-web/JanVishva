...
"[project]/janvishwa/node_modules/@clerk/nextjs/dist/esm/server/keyless-telemetry.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function tryMarkTelemetryEventAsFired() {
    try {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$janvishwa$2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$utils$2f$feature$2d$flags$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["canUseKeyless"]) {
            const { mkdirSync, writeFileSync } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$janvishwa$2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$fs$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["nodeFsOrThrow"])();
            const path = (0, __TURBOPACK__imported__module__$5b$project$5d2f$janvishwa$2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$fs$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["nodePathOrThrow"])();
...
async function detectKeylessEnvDrift() {
    ...
    ;
    try {
        const { safeParseClerkFile } = await __turbopack_context__.A("[project]/janvishwa/node_modules/@clerk/nextjs/dist/esm/server/keyless-node.js [app-rsc] (ecmascript, async loader)");
        const keylessFile = safeParseClerkFile();
        if (!keylessFile) {
            return;
        }
        const envPublishableKey = ("TURBOPACK compile-time value", "pk_test_c3VwcmVtZS1waXBlZmlzaC01OC5jbGVyay5hY2NvdW50cy5kZXYk");
        ...
        const clerkClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$janvishwa$2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$createClerkClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClerkClientWithOptions"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66fe7be8._.js.map